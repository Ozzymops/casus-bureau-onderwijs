...
namespace BureauOnderwijs.Views
{
    public partial class UpdateModule : System.Web.UI.Page
    {
        ...
        protected void BTSend_Click(object sender, EventArgs e)
        {
            ...
            string name = m.UpdateModuleCC(TBName.Text, TBModuleCode.Text, Convert.ToInt32(TBPeriod.Text), Convert.ToInt32(TBYear.Text), TBFaculty.Text, TBProfile.Text, Convert.ToInt32(TBCredits.Text), CheckBoxGeneralModule.Checked, Convert.ToInt32(TBExaminor.Text), TBDescription.Text, Convert.ToInt32(TBLectureHours.Text), Convert.ToInt32(TBPracticalHours.Text), Convert.ToInt32(TBModuleId.Text) ,ingelogd);
